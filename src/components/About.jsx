    ...
    return (
            <div data-scroll data-scroll-section data-scroll-speed=".1"  className=" bg-[#CDEA68] rounded-tl-2xl rounded-tr-2xl md:h-screen ">
                <div className="py-10 mx-5 md:mx-20 text-black">
                    <h1 className="text-4xl font-Secondary"> Prayoga Ajitya Setiawan, a 4nd semester student of Informatics Engineering Budi Luhur University,<span className="underline">I am from Lamongan, East Java,</span>  and now living in Jakarta I want to become a <span className="underline">frondend programmer.</span></h1>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-5 ">
                        <div className="md:w-1/2 mx-5  md:mx-20">
                            ...
                            <ul className="list-disc list-inside">
                                <li className="text-lg text-zinc-700 font-semibold underline">
