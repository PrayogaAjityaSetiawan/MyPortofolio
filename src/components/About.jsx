...
const About = () => {
    ...
    return (
        ...
        className= {
            darkMode 
            ? "bg-[#0c1a18] py-4 rounded-tl-3xl rounded-tr-3xl md:max-h-screen " 
            : "bg-[#CDEA68] py-4 rounded-tl-3xl rounded-tr-3xl md:max-h-screen "
            }>
...
>
  {/* Konten opsional */}
                ...
                <div className="md:w-1/2 flex flex-col justify-between">
                    <p className={darkMode ? "font-Primary text-white text-base md:text-xl ": "font-Primary text-black text-base md:text-xl"}>{textAbout}</p>
                            ...
                            <Marquee
                              ...
                              >
                                  {icons.map((item, index) => (
                                    <span 
                                      className={darkMode ? "grayscale hover:scale-105 hover:grayscale-0 transition-all hover:ease-in" : ""}
                                      key={index} >
                                      {item.icon}
                                    </span>
                                  ))}
